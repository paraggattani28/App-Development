...
import 'package:project3/screens/Home/upload_judo.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:project3/screens/Home/useruploads.dart';

class Judo extends StatefulWidget {
  @override
  _JudoState createState() => _JudoState();
}

class _JudoState extends State<Judo> with TickerProviderStateMixin {
                      ...
                      floatingActionButton: FloatingActionButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => UploadJudovideo()),
                          );
                        },
                        child: Icon(
                          Icons.add,
