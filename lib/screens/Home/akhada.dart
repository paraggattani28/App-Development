...
import 'package:project3/screens/Home/upload_akhada.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:project3/screens/Home/useruploads.dart';

class Akhada extends StatefulWidget {
  @override
  _AkhadaState createState() => _AkhadaState();
}

class _AkhadaState extends State<Akhada> with TickerProviderStateMixin {
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseHome().akhadaData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
