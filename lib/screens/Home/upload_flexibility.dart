...
class UploadFlexibilityvideo extends StatefulWidget {
  @override
  _UploadFlexibilityState createState() => _UploadFlexibilityState();
}

class _UploadFlexibilityState extends State<UploadFlexibilityvideo>
                      ...
                      ListTile(
                        ...
                        onTap: () async {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => UploadFlexibilityvideo()),
                          );
                        },
                      ),
                      ListTile(
                                  ...
                                  onPressed: () async {
                                    ...
                                    videoFolderRef
                                      ...
                                      await DatabaseService(uid: user.uid)
                                          .updateFlexibilityData(
                                              title, details, _videoLink);
                                      await DatabaseHome()
                                          .updateFlexibilityDataHome(
                                              title, details, _videoLink);
                                    });
                                  },
                                  color: Colors.pinkAccent,
