...
class UserCrossfit extends StatefulWidget {
  @override
  _UserCrossfitState createState() => _UserCrossfitState();
}

class _UserCrossfitState extends State<UserCrossfit>
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseService(uid: user.uid).crossfitData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
