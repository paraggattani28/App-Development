...
class UserCardio extends StatefulWidget {
  @override
  _UserCardioState createState() => _UserCardioState();
}

class _UserCardioState extends State<UserCardio> with TickerProviderStateMixin {
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseService(uid: user.uid).cardioData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
