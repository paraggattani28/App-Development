...
class UploadJudovideo extends StatefulWidget {
  @override
  _UploadJudoState createState() => _UploadJudoState();
}

class _UploadJudoState extends State<UploadJudovideo>
                                ...
                                FlatButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    videoFolderRef
                                      ...
                                      await DatabaseHome().updateJudoDataHome(
                                          title, details, _videoLink);
                                    });
                                  },
                                  color: Colors.pinkAccent,
