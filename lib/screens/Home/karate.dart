...
import 'package:project3/screens/Home/upload_karate.dart';
...
class _KarateState extends State<Karate> with TickerProviderStateMixin {
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseHome().karateData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
