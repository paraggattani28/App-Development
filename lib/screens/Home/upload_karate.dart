...
class UploadKaratevideo extends StatefulWidget {
  @override
  _UploadKarateState createState() => _UploadKarateState();
}

class _UploadKarateState extends State<UploadKaratevideo>
                      ...
                      ListTile(
                        ...
                        onTap: () async {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => UploadKaratevideo()),
                          );
                        },
                      ),
                      ListTile(
                                ...
                                FlatButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    videoFolderRef
                                      ...
                                      await DatabaseHome().updateKarateDataHome(
                                          title, details, _videoLink);
                                    });
                                  },
                                  color: Colors.pinkAccent,
