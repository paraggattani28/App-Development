...
class UserJudo extends StatefulWidget {
  @override
  _UserJudoState createState() => _UserJudoState();
}

class _UserJudoState extends State<UserJudo> with TickerProviderStateMixin {
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseService(uid: user.uid).judoData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
