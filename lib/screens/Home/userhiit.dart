...
class UserHiit extends StatefulWidget {
  @override
  _UserHiitState createState() => _UserHiitState();
}

class _UserHiitState extends State<UserHiit> with TickerProviderStateMixin {
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseService(uid: user.uid).hiitData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
