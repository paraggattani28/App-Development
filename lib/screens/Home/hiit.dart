...
import 'package:project3/screens/Home/upload_hiit.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:project3/screens/Home/useruploads.dart';

class Hiit extends StatefulWidget {
  @override
  _HiitState createState() => _HiitState();
}

class _HiitState extends State<Hiit> with TickerProviderStateMixin {
                      ...
                      floatingActionButton: FloatingActionButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => UploadHiitvideo()),
                          );
                        },
                        child: Icon(
                          Icons.add,
