...
import 'package:project3/screens/Home/upload_circuit.dart';
...
class _CircuitState extends State<Circuit> with TickerProviderStateMixin {
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseHome().circuitData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
