...
class UserFlexibility extends StatefulWidget {
  @override
  _UserFlexibilityState createState() => _UserFlexibilityState();
}

class _UserFlexibilityState extends State<UserFlexibility>
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseService(uid: user.uid).flexibilityData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
