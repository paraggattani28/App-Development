...
class UserCircuit extends StatefulWidget {
  @override
  _UserCircuitState createState() => _UserCircuitState();
}

class _UserCircuitState extends State<UserCircuit>
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseService(uid: user.uid).circuitData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
