...
class UploadCircuitvideo extends StatefulWidget {
  @override
  _UploadCircuitState createState() => _UploadCircuitState();
}

class _UploadCircuitState extends State<UploadCircuitvideo>
                      ...
                      ListTile(
                        ...
                        onTap: () async {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => UploadCircuitvideo()),
                          );
                        },
                      ),
                      ListTile(
