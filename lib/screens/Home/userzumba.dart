...
class UserZumba extends StatefulWidget {
  @override
  _UserZumbaState createState() => _UserZumbaState();
}

class _UserZumbaState extends State<UserZumba> with TickerProviderStateMixin {
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseService(uid: user.uid).zumbaData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
