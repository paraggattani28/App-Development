...
class UploadStrengthvideo extends StatefulWidget {
  @override
  _UploadStrengthState createState() => _UploadStrengthState();
}

class _UploadStrengthState extends State<UploadStrengthvideo>
                      ...
                      ListTile(
                        ...
                        onTap: () async {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => UploadStrengthvideo()),
                          );
                        },
                      ),
                      ListTile(
