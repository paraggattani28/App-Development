...
class UploadHiitvideo extends StatefulWidget {
  @override
  _UploadHiitState createState() => _UploadHiitState();
}

class _UploadHiitState extends State<UploadHiitvideo>
                                ...
                                FlatButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    videoFolderRef
                                      ...
                                      await DatabaseHome().updateHiitDataHome(
                                          title, details, _videoLink);
                                    });
                                  },
                                  color: Colors.pinkAccent,
