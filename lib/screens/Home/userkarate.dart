...
class UserKarate extends StatefulWidget {
  @override
  _UserKarateState createState() => _UserKarateState();
}

class _UserKarateState extends State<UserKarate> with TickerProviderStateMixin {
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseService(uid: user.uid).karateData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
