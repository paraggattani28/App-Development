...
import 'package:project3/screens/Home/upload_resistance.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:project3/screens/Home/useruploads.dart';

class Resistance extends StatefulWidget {
  @override
  _ResistanceState createState() => _ResistanceState();
}

class _ResistanceState extends State<Resistance> with TickerProviderStateMixin {
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseHome().resistanceData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                      ...
                      floatingActionButton: FloatingActionButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => UploadResistancevideo()),
                          );
                        },
                        child: Icon(
                          Icons.add,
