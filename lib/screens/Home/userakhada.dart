...
class UserAkhada extends StatefulWidget {
  @override
  _UserAkhadaState createState() => _UserAkhadaState();
}

class _UserAkhadaState extends State<UserAkhada> with TickerProviderStateMixin {
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseService(uid: user.uid).akhadaData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
