...
import 'package:project3/screens/Home/upload_cardio.dart';
...
class _CardioState extends State<Cardio> with TickerProviderStateMixin {
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseHome().cardioData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
