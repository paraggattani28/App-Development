...
class UserResistance extends StatefulWidget {
  @override
  _UserResistanceState createState() => _UserResistanceState();
}

class _UserResistanceState extends State<UserResistance>
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseService(uid: user.uid).resistanceData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
