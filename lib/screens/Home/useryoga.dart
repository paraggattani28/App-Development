...
class UserYoga extends StatefulWidget {
  @override
  _UserYogaState createState() => _UserYogaState();
}

class _UserYogaState extends State<UserYoga> with TickerProviderStateMixin {
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseService(uid: user.uid).yogaData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
