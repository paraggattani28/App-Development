...
import 'package:project3/screens/Home/upload_crossfit.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:project3/screens/Home/useruploads.dart';

class Crossfit extends StatefulWidget {
  @override
  _CrossfitState createState() => _CrossfitState();
}

class _CrossfitState extends State<Crossfit> with TickerProviderStateMixin {
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: DatabaseHome().crossfitData,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                      ...
                      floatingActionButton: FloatingActionButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => UploadCrossfitvideo()),
                          );
                        },
                        child: Icon(
                          Icons.add,
